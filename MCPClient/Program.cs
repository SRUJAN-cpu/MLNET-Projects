...
///
/// If no arguments are provided, it defaults to running the WeatherMCP project from the current repo.
///
...
static (string command, string[] arguments) GetCommandAndArguments(string[] args)
{
	return args switch
	{
		...
		_ => ("dotnet", ["run", "--project", Path.Combine(GetCurrentSourceDirectory(), "../WeatherMCP")])
	};
}
